...
Connect DUBU to the web with fast, parallel search capabilities.
...
Anyone who wants Dubu to have access to current information from the web.
...
```bash
integrations/parallel-search/setup.sh
```
...
After setup, try these commands with Dubu:
